	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "ShaderGraphLibrary/Functions.hlsl"
							...
							float4 _PBRMaster_6A898101_Normal;
							float4 _PBRMaster_6A898101_Emission;
							float _PBRMaster_6A898101_Metallic;
							float _PBRMaster_6A898101_Smoothness;
							float _PBRMaster_6A898101_Occlusion;
							float _PBRMaster_6A898101_Alpha;
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								surface.Albedo = (_SampleTexture2D_A3C9A2CE_RGBA.xyz);
								surface.Normal = _PBRMaster_6A898101_Normal;
								surface.Emission = _PBRMaster_6A898101_Emission;
								surface.Metallic = _PBRMaster_6A898101_Metallic;
								surface.Smoothness = _PBRMaster_6A898101_Smoothness;
								surface.Occlusion = _PBRMaster_6A898101_Occlusion;
								surface.Alpha = _PBRMaster_6A898101_Alpha;
								surface.AlphaClipThreshold = _SampleTexture2D_A3C9A2CE_A;
								return surface;
							}
